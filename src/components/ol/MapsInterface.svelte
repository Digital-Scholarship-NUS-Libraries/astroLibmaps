...
<div
  ...
  class="absolute top-40 md:top-4 p-4 rounded-r-lg backdrop-blur-md bg-base-100/80"
>
  <svg
...
<div
  ...
  class="max-h-[calc(100vh-11rem)] md:max-h-[calc(100vh-2rem)] overflow-scroll p-4 my-4 absolute top-36 md:top-0 rounded-r-lg backdrop-blur-md bg-base-100/80"
>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 384 512"
